...
def twenergy_score(
    ...
    *,
    ...
    r"""Compute the Threshold-Weighted Energy Score for a finite multivariate ensemble.
...
def vrenergy_score(
    ...
    *,
    ...
    r"""Compute the Vertically Re-scaled Energy Score for a finite multivariate ensemble.
